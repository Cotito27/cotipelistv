  ...
  $('.search__icon').on('click', async function() {
    if($('.input__search').val() == '') {
      ...
      if(res.pages == 0) {
        ...
        $('.search__icon').html(`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512.005 512.005" style="enable-background:new 0 0 512.005 512.005;" xml:space="preserve">
        <g>
          <g>
